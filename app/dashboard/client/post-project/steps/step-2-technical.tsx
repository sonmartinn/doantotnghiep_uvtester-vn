                        ...
                        onChange={async e => {
                          ...
                          if (files.length > 0) {
                            ...
                            try {
                              ...
                              toast.success(`Đã upload ${urls.length} tài liệu`)
                            } catch (error) {
                              console.error(error)
                        ...
                        return (
                          ...
                          >
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                handleRemoveFile(index, field.value as string[])
                              }
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="iPhone 13, Samsung S21..." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="iOS 15, Android 12..." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Chrome, Safari..." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
